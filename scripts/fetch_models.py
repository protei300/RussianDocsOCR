...
cloning, and again after pulling a release that changed models.

  python scripts/fetch_models.py            # fetch what is missing or wrong
  python scripts/fetch_models.py --check    # verify only, exit 1 on mismatch
...
def main():
    ...
    if args.check:
        ...
        print('run scripts/fetch_models.py to fix')
        return 1
